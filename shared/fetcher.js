  ...
  _.each(fetchSpecs, function(spec, name) {
    batchedRequests[name] = function(cb) {
      ...
      if (!options.readFromCache) {
        ...
        if (spec.model != null) {
          this._retrieveModel(spec, function(modelData) {
...
Fetcher.prototype._retrieveModel = function(spec, callback) {
  ...
  modelUtils.modelIdAttribute(spec.model, function(idAttribute)
  {
    ...
    return callback(_fetcher.modelStore.find(spec.model, spec.params));
  });
};
